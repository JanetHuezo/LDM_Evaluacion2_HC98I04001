...
public class CalculadoraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            btnParenIzq.setOnClickListener(this);
            btnParenDer.setOnClickListener(this);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()){
                ...
                case R.id.btnDiv:
                    entrada.append("/");
                    break;
                case R.id.btnParentIzq:
                    entrada.append("(");
                    break;
                case R.id.btnParentDerecho:
                    entrada.append(")");
                    break;
                case R.id.btnPunto:
                    entrada.append(".");
                ...
                case R.id.btnIgual:
                    if (txtEntrada.getText()!="") {
                        ...
                        Toast toast = Toast.makeText(this, "No hay valores que operar", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                    break;
            }
